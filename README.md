...
This is a [Commodore][commodore] Component for Kubernetes operator for Netbird.
...
The rendered documentation for this component is available on the [Commodore Components Hub](https://hub.syn.tools/netbird-operator).
